...
function PsyTestEvaluation() {
  return (
    <div className="w-1/2 mx-auto my-16 h-48 bg-gray-700 border-4 border-orange-400/50 border-dashed rounded-lg text-center cursor-pointer flex justify-center items-center flex-col-reverse ">
      ...
      <div className="relative">
        ...
        <FaWalking
          className={
            "text-4xl text-orange-400 mx-auto h-12 animate-pulse relative -top-12 "
          }
        />
      </div>
    </div>
...
export function PsychologyTest() {
  return (
    <div className="w-full p-4 text-center bg-gray-900 border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700  ">

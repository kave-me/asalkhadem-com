		...
		<div className="px-6 pt-14 pb-6 md:px-8 md:pb-6 relative bg-white shadow-sm rounded">
			...
			<div className="relative h-full">
				<blockquote className="flex flex-col h-full justify-between items-start ">
					<p
						className="font-sans font-medium drop-shadow-sm text-[13px] text-gray-700 leading-8 mb-4 line-clamp-none">{quote}</p>
					<footer className="flex items-center gap-4 md:-mr-2.5 md:-mb-1 ">
						<span

							className="rounded-full overflow-hidden w-12 h-12  border-2 border-gray-100 bg-gray-50"
						>
...
export function Testimonial() {
	const data = [
		...
		{
			quote: "عملکرد ایشون رو دوست دارم ،من در طول جلسه احساس آرامش دارم و احساس فشار یا اذیت شدن ندارم و میتونم در زمان مناسب حرف هامو بیان کنم. ",
			name: "مهرانا",
			context: "1402/05/13",
		},
		{
			quote: "من برای اضطراب شدید داشتم مراجعه کردم و با صحبت و راهکارهایی که دادن الان خیلی بهتر شدم بسیار خوش اخلاق، شنونده خوب و با حوصله راهکارهای خیلی خوب و کاربردی رو ارائه میدن. ",
			name: "ناشناس",
			context: "1401/05/12",
		},
		{
			quote: "خانم دکتر بسیار دلسوز و حاذق هستند در طول جلسه تمامیت ایشون برای مراجع کاملا قابل لمسه منفعل و تنها شنونده نیستند نظرات متخصصانه ی ایشون من را به خودم خیلی آگاه کرد و با همراهی و پیگیری های ایشون تونستم از پس مشکلاتم بگذرم پر از حس امنیت ، آرامش، اعتماد بودند سپاسگذارم.",
			name: "منصوره",
			context: "1402/05/12",
		},
		{
			...
			quote: "از نظر شروع جلسه و ارتباط برقرار شدن و ایجاد حس امنیت و راحتی که خیلییی مهمه بسیار عالییی بودند از همون جلسه اول بسیار راضی و تاثیرات بسیار خوب توی تجربه روان درمانگری که حین ۲سال داشتم ایشون بهترین روان درمانگری بودن که شناختم و خوشحالم ازین بابت تشکر از تراپیست عزیزم ",
			name: "ناشناس",
			context: "1402/05/16",
		}
	...
	return (
		<div
			className="bg-[conic-gradient(at_right_center,_var(--tw-gradient-stops))] from-green-100 via-blue-50 via to-indigo-100 via border-y-2 border-dashed border-indigo-200 ">

...
export function JoinCommunity() {
	return (<div className="bg-white py-16 border-y-2 border-dashed border-indigo-100">
		...
		<div className="container rounded   mx-auto max-w-max ">
            ...
            انسان ابتدا وجود دارد و سپس خود را
            می‌سازد.
            </span>
					<br/>
					<span>

            انسان ابتدا چیزی نیست و بعد از آن چیزی می‌شود.
</span>
					<br/>
					<span>

            انسان ابتدا
            وجود دارد و سپس ماهیت می‌یابد.
            </span>
					<br/>
					<span>
            وجود انسان بر ماهیت او تقدم دارد.
					...
					<br/>
					<span>
            انسان ابتدا وجود دارد و سپس خود را می‌سازد.
</span>
				...
				<p
					className=" text-base pt-4 md:text-base md:leading-relaxed font-black text-gray-600 lg:w-2/3 mx-auto text-indigo-700">
					انسان چیزی نیست جز همان که خود از خویش ساخته است و نخستین اصل، اصالت وجود است.
				</p>
			</div>
		</div>
	</div>);

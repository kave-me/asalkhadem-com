...
function AboutMeTop({ heading }: HeadProps) {
  return (
    <header className="text-center ">
      ...
      <h2 className="text-2xl md:text-4xl font-sans font-black mb-8">
        {heading}
      </h2>
      ...
      <div className="p-2 bg-white rounded-lg my-10 hover:bg-indigo-500 transition relative aspect-[4/1] max-w-2xl mx-auto ">
        <Image
          src="/img/hero.png"
          alt="hero"
          fill={true}
          sizes={"100%"}
          className={
            "rounded-lg aspect-[4/3] object-cover object-center w-full h-full  shadow-lg drop-shadow-lg bg-black bg-opacity-5 opacity-90 hover:opacity-100 transition cursor-pointer hover:scale-105 active:scale-95 "
          }
        />
      </div>

      <h4 className="text-lg md:text-xl md:leading-relaxed font-bold tracking-tighter text-gray-700 lg:w-2/3 mx-auto">
...
export function AboutMeSection() {
  ...
  return (
    <div className="bg-gray-100">
      <div className="container xl:max-w-7xl mx-auto px-4 py-16 lg:px-8 lg:py-32 space-y-10 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-gray-50 via-indigo-100 to-gray-100 border-x-2 border-dashed border-indigo-200 border-b-2">
        <AboutMeTop heading={heading} subHead={subHead} />
        <section className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8 bg-gradient-to-b from-gray-100 to-indigo-100/30 p-4 rounded-b-lg border-b-2 border-l-2  border-indigo-500/10 border-dashed ">
          {cards.map((card) => (
